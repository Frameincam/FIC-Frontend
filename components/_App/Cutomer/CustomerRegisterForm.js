...
const CutomerRegisterForm = () => {
  ...
  // Customer Normal Registration Start
  ...
  //   Customer Normal Registration End
  ...
  const googleCustomerLoginSuccess = async (res) => {
    ...
    try {
      const google = await axios.post(
        `${process.env.DOMAIN_NAME}/api/account/customer/google-register/${res.tokenId}`
      );
  ...
  const responseFacebook = async (response) => {
    ...
    try {
      const faceBookLoginApi = await axios.post(
        `${process.env.DOMAIN_NAME}/api/account/customer/facebook-register`,
        data
      );
      ...
      if (faceBookLoginApi.data.success) {
        ...
        localStorage.setItem("token", token);
        localStorage.setItem("user", JSON.stringify(faceBookLoginApi.data.user));
        router.push("/dashboard/customerprofile");
      }
    } catch (error) {
      console.log(error);
    ...
    <>
      ...
      <div className="tab-pane" id="register">
        <div className="miran-register">
          ...
          <form onSubmit={handleSubmit(customerRegistrationSubmit)}>
...
export default CutomerRegisterForm;
